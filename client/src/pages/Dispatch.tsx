...
import { Truck, MapPin, Clock, ClipboardCheck, Phone, User, ChevronLeft, ChevronRight } from "lucide-react";
...
function JobRow({ job, crews, onChange }: { job: Job; crews: Crew[]; onChange: (data: any) => void }) {
