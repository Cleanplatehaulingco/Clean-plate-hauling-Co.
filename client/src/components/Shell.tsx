...
import {
  ...
  MessageSquareText, Settings as SettingsIcon, Sun, Moon, Radio, Sparkles, Hammer,
} from "lucide-react";
...
export function Shell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex bg-background text-foreground">
      {/* SIDEBAR */}
      <aside
        className="hidden md:flex w-[240px] flex-col bg-sidebar text-sidebar-foreground border-r border-sidebar-border"
        data-testid="sidebar"
      >
        ...
        {/* Bottom status block */}
        <div className="m-3 rounded-md border border-sidebar-border bg-sidebar-accent/40 p-3 space-y-2">
